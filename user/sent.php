...
?>
                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h5 class="card-header m-0 me-2 pb-3">E-Message</h5>
                       <hr>
    ...
    foreach($selectMessage as $messages)
    {
        ...
        <div class="accordion-header" style="border-bottom:1px solid;background:#375E97;color:white"><?php echo $messages['receiver_name'].' '.$messages['date']?></div>
    
        <div class="accordion-content">
      
            <p>From :<?php echo $messages['sender_name'] ?></p>
            <p>To :<?php echo $messages['receiver_name']?></p>
