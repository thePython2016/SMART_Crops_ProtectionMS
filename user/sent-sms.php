...
>
  <head>
    ...
    <style>
      /* Fix: make layout fill full viewport height so footer stays at bottom */
      html, body {
        height: 100%;
      }
      ...
      /* Left/Right panel styles (kept from original) */
      .left-panel {
        width: 200px;
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <!-- Content wrapper — flex column so footer is pushed to bottom -->
          <div class="content-wrapper">
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        ...
                        <!-- ================================================ -->
                        <div id="apiKeyAlert" role="alert" style="margin-left:20px;">
            ...
            <!-- Footer — now correctly at the bottom -->
