...
?>
                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h5 class="card-header m-0 me-2 pb-3">Add /View Farmers</h5>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="tab1-tab" data-bs-toggle="tab" href="#farmersForm" role="tab" aria-controls="tab1" aria-selected="true">Farmers</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab3-tab" data-bs-toggle="tab" href="#editUpdate" role="tab" aria-controls="tab3" aria-selected="false">Farmers List</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab2-tab" data-bs-toggle="tab" href="#uploadForm" role="tab" aria-controls="tab2" aria-selected="false">Upload (Farmers)</a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="farmersForm" role="tabpanel" aria-labelledby="tab1-tab">
  ...
  <div class="first-row-form">
  <div class="mb-3">
    <label for="exampleInputPassword1" id="InputFirstname"   class="form-label">First name</label>
    <input type="text" class="form-control" name="fname" id="InputFirstname" required    placeholder="First name">
  </div>

  <div class="mb-3">
    <label for="exampleInputPassword1" id="InputLastname" class="form-label">Middle name</label>
    <input type="text" class="form-control" name="mname" id="InputLastname" required    placeholder="Middle name">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Last name</label>
    <input type="text" class="form-control" name="lname" id="InputLastname" required    placeholder="Last name">
  </div>
</div>
<label for="exampleInputPassword1" class="form-label">Birth date</label>
<div class="second-row-form">
  <div class="mb-3">
  <select class="form-select" id="Inputday" name="birthDay" required>
  ...
  <div class="mb-3">
    ...
    <select class="form-select"  id="Inputmonth" name="birthMonth" required>
  ...
  <div class="mb-3">
  <select class="form-select" id="Inputyear" name="birthYear" required>
...
<div class="second-row-form">
  ...
  <select class="form-select"  id="gender" aria-label="Select Gender" name="gender" required>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1"  id="Inputaddress"  class="form-label">Region</label>
    <input type="text" class="form-control" id="Inputaddress" name="region" required    placeholder="Region">
  </div>
</div>
  ...
  <button type="submit" name="submit" class="btn btn-primary submitBtn">Submit</button>
        ...
        <div class="tab-pane fade" id="editUpdate" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <div >
              <!-- Fetch data from farmers Table -->
          
            <table id="farmersTable" class="table  table-hover table-striped table-bordered" >
            <thead>
                <tr>
                    <th>Mobile number</th>
                    <th>Email</th>
...
{
  $id=$farmers['mobileNumber'];
  ?>
               
                <tr>
                    <td><?php echo $farmers['mobileNumber']?></td>
                    <td><?php echo $farmers['email']?></td>
...
?>
        ...
        <div class="tab-pane fade" id="uploadForm" role="tabpanel" aria-labelledby="tab3-tab">
            ...
            <form name=""  method="POST" action="importFarmers.php" enctype="multipart/form-data">
            <input type="file" name="farmers_file" class="form-control" id="Inputaddress">
            <button type="submit" name="importFarmers" class="btn  uploadBtn">Upload</button>
</form>
        </div>
        ...
        <a href="downloads/farmers.csv"  class="payment-sample" download="farmers.csv">Farmers</a> <br>
