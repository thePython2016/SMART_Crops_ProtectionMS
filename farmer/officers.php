...
require "profile.php";
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-3 order-1">
                  <div class="row">
                    ...
                    <a class="btn addBtn" href="officers.php">Add Officers</a>
</div>
</div>
</div>
                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h5 class="card-header m-0 me-2 pb-3">Add /View Officers</h5>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="tab1-tab" data-bs-toggle="tab" href="#officersForm" role="tab" aria-controls="tab1" aria-selected="true">Officers</a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab2-tab" data-bs-toggle="tab" href="#uploadForm" role="tab" aria-controls="tab2" aria-selected="false">Upload (Officers)</a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="officersForm" role="tabpanel" aria-labelledby="tab1-tab">
    ...
    <input type="phone" id="mobile-number"  placeholder="Mobile number" name="phone" class="form-control" maxlength="12" placeholder="076-123-7891" required>
    
    
  </div>
  <div class="mb-3" style="margin-left:10px">
    <label for="exampleInputEmail1" class="form-label" id="Inputmobile" >Occupation</label>
    <input type="text" class="form-control" name="occupation" id="Inputmobile" aria-describedby="emailHelp" required placeholder="First Occupation">
...
?>
        ...
        <div class="tab-pane fade" id="uploadForm" role="tabpanel" aria-labelledby="tab3-tab">
            ...
            <form name="" action="importOfficers.php" method="POST" enctype="multipart/form-data">
            <input type="file" class="form-control" name="officers-file" id="Inputaddress">
            <button type="submit" name="importOfficers" class="btn  uploadBtn">Upload</button>
</form>
        </div>
        ...
        <a href="downloads/Agro-officers.csv"  class="payment-sample" download="Agro-officers.csv">Agro Officers</a> <br>
