                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h5 class="card-header m-0 me-2 pb-3">Agro-Inputs List</h5>
        ...
        $(document).ready(function() {
            ...
            $("#delete-button").click(function() {
                ...
                if (confirm("Are you sure you want to delete this record?")) {
                    window.location.href = 'deleteinputsScripts.php?id=' + selectedId; // Redirect to delete.php
                }
            });
        });
    </script>
...
<h3 style="margin-top:30px">Update Record</h3>
        ...
        <div class="row">
          <div class="col-8">
            <div class="block1">
          <div class="mb-3">
          <input type="hidden" id="updateid" name="number">
  </div>
          <div class="mb-3">
...
<div class="block2">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Usage</label>
    <input type="text" class="form-control" name="usage" id="usage">
        ...
        <button type="submit" id="updateButton" style="margin-bottom:20px;margin-left:100px" name="updateInputs" class="btn btn-primary submitBtn">Update selected</button>
...
<?php
      ...
      <button id="delete-button" type="submit"  class="btn btn-primary submitBtn">Delete selected</button>
