                ...
                <div class="col-md-6 mb-4">
                  <div class="card h-100">
                    <div class="card-header justify-content-between">
                      ...
                      <canvas id="chart" style="width:100px !important"></canvas>
                        <!-- Charts -->
  <script>
    
    const labels4 = ['Mwanza','Simiyu','Tabora','Geita','Arusha','Mbeya','Iringa','Mara'];
  const data4 = {
    labels: labels4,
    datasets: [{
      label: 'Number of Registered Framers by Region',
                ...
                <!--/ Transactions -->
                  ...
                  <div class="card h-100">
                    <div class="card-header justify-content-between">
                      ...
                      <canvas id="lineChart" style="width:100px !important"></canvas>
                        <!-- Charts -->
  <script>
